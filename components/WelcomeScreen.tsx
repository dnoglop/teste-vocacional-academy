...
import { Sparkles, RefreshCw, ShieldCheck, Award } from 'lucide-react'; // Importando ícones do lucide-react
      ...
      <section className="py-16 bg-gray-800 text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Card 1 */}
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg flex flex-col items-start text-left animate-fade-in-up delay-500 border border-gray-600">
              <div className="bg-orange-600/20 p-3 rounded-full mb-4">
            ...
            {/* Card 2 */}
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg flex flex-col items-start text-left animate-fade-in-up delay-600 border border-gray-600">
              <div className="bg-orange-600/20 p-3 rounded-full mb-4">
            ...
            {/* Card 3 */}
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg flex flex-col items-start text-left animate-fade-in-up delay-700 border border-gray-600">
              <div className="bg-orange-600/20 p-3 rounded-full mb-4">
            ...
            {/* Card 4 */}
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg flex flex-col items-start text-left animate-fade-in-up delay-800 border border-gray-600">
              <div className="bg-orange-600/20 p-3 rounded-full mb-4">
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-200 border border-gray-700">
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-300 border border-gray-700">
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-400 border border-gray-700">
      ...
      <section className="py-16 bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-200 border border-gray-600">
            ...
            <div className="bg-gray-700 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-300 border border-gray-600">
