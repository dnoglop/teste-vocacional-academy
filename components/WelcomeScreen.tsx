    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen-75vh p-4 md:p-8 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10">
          ...
          <div className="absolute top-1/2 right-1/4 w-64 h-64 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
      ...
      <section className="py-16 bg-gray-800 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-indigo-300 mb-8 animate-fade-in-up delay-400">O que esperar do teste?</h2>
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-400 mb-8 animate-fade-in-up">Nossa Metodologia</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-200">
              <h3 className="font-bold text-xl text-indigo-300 mb-2">Interesses RIASEC</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-300">
              <h3 className="font-bold text-xl text-indigo-300 mb-2">Valores de Trabalho</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-lg text-left animate-fade-in-up delay-400">
              <h3 className="font-bold text-xl text-indigo-300 mb-2">Estilo de Trabalho Ideal</h3>
              <p className="text-gray-300">
      ...
      <section className="py-16 bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-green-400 mb-8 animate-fade-in-up">Inclusão e Acolhimento</h2>
          <p className="text-lg text-gray-300 mb-10 animate-fade-in-up delay-100">
      ...
      <section className="py-16 bg-gray-900 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-6 animate-fade-in-up">
            Pronto para começar sua jornada de autodescoberta?
          </h2>
          <button 
            onClick={onStart} 
            className="px-12 py-4 text-lg font-bold text-white bg-indigo-600 rounded-full hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 transform hover:scale-105 transition-all duration-300 ease-in-out shadow-lg animate-fade-in-up delay-100"
          >
            Iniciar Teste Agora
          </button>
        </div>
